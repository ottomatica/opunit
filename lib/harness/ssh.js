    ...
    async setup( context, setup ) {
        ...
        return new Promise( function ( resolve, reject ) {
            if ( setup && setup.cmd ) {
                ...
                let child = child_process.spawn( `ssh -i ${self.sshConfig.private_key} -o StrictHostKeyChecking=no -o IdentitiesOnly=yes ${self.sshConfig.user}@${self.sshConfig.hostname} bash -c "${setup.cmd}"`, {
                    shell: true
                } );
